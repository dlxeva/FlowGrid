...
- **宿主无关：** 可嵌入 Codex、Claude、OpenHands、Hermes 或任何能读文件/跑命令的 AI agent work 产品
...
这条流程可以运行在 Codex、Claude、OpenHands、Hermes 或其他 AI agent work 产品里，不要求用户改用新的工作台。
...
- 用户继续在 Codex / Claude / OpenHands / Hermes 等 AI agent work 产品里自然说话
- AI 在合适的时候调用 `flg`
